    ...
    <div className="space-y-6">
        ...
        {best ? (
          <>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-4">
              ...
              <Stat label="Experience asked" value={`${best.avgMinExperience}-${best.avgMaxExperience} yr`} />
          ...
          <div key={city.city} className="panel p-6">
            ...
            <div className="mt-5 space-y-3 text-sm">
              <div>
                ...
                <Progress
                  value={city.matchingJobs ? (city.jobsInYourBand / city.matchingJobs) * 100 : 0}
                />
              </div>
            ...
            <Section icon={<Building2 className="size-4 text-primary" />} title="Companies hiring">
            ...
            {city.missingSkills.length > 0 ? (
              <Section icon={<Sparkles className="size-4 text-accent" />} title="Skills to add">
                {city.missingSkills.map((s) => (
                  <Badge key={s} className="bg-accent/15 font-normal text-accent hover:bg-accent/20">
                    {s}
                  </Badge>
                ))}
              </Section>
      ...
      {report.globalSkillGaps.length > 0 ? (
        <div className="panel p-6">
          <h3 className="text-lg font-semibold">Highest-leverage skills missing from your resume</h3>
